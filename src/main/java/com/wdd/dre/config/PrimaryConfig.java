...
@EnableJpaRepositories(entityManagerFactoryRef = "entityManagerFactoryPrimary",
		transactionManagerRef = "transactionManagerPrimary",basePackages = "com.wdd.dre.domain.repository")
@EntityScan(basePackages = "com.wdd.dre.domain.entity")
...
public class PrimaryConfig {
	...
	public LocalContainerEntityManagerFactoryBean entityManagerFactoryPrimary() {
		...
		factory.setPackagesToScan("com.wdd.dre.domain.entity"); // 实体扫描
